...
ActiveRecord::Schema.define(version: 20161027185844) do
  ...
  create_table "emotionalproblem_villians", force: :cascade do |t|
  ...
  create_table "emotionalproblems", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "superheros_superpowers", id: false, force: :cascade do |t|
